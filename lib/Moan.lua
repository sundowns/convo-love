...
function Moan.draw()
  ...
  if Moan.showingMessage then
    ...
    local boxH = Moan.boxH
    local boxW = Moan.boxW
    local boxX = Moan.boxX
    local boxY = Moan.boxY
...
--Simple function to override box position and dimensions
function Moan.setBoxBounds(x, y, w, h)
  Moan.boxX = x
  Moan.boxY = y
  Moan.boxW = w
  Moan.boxH = h
